...
const mockClaudeResponse = {
  ...
  reasoning: "Given the high fatigue severity (8/10) combined with daily fried food consumption, assessing postprandial energy crashes is critical. This will help determine if the fatigue is related to metabolic dysfunction from seed oil exposure and poor blood sugar regulation.",
  questionsToSkip: ["screening_4", "screening_5"],
  skipReason: "Basic sleep questions are less relevant given the severity and pattern suggesting metabolic issues rather than simple sleep deprivation",
...
console.log('- Why: High fatigue + daily fried foods suggests metabolic dysfunction');
