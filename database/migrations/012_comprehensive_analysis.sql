-- Migration 012: Comprehensive Analysis System
-- This migration adds support for the comprehensive AI-powered client analysis system

-- Create comprehensive_analyses table for storing complete analysis results
...
-- Create supplement_recommendations table for tracking supplement suggestions
...
-- Create progress_tracking table for monitoring client progress over time
...
-- Create analysis_artifacts table for storing generated reports
...
-- Insert sample data for testing (if any clients exist)
DO $$
DECLARE
  sample_client_id UUID;
BEGIN
  -- Get a sample client if any exist
  SELECT id INTO sample_client_id FROM clients LIMIT 1;
  
  IF sample_client_id IS NOT NULL THEN
    -- Insert sample comprehensive analysis
    INSERT INTO comprehensive_analyses (
      ...
      '[
        {
          ...
          "confidence": 85,
          "explanation": "Elevated inflammatory markers and symptoms indicate systemic inflammation",
      ...
      '{
        "phase1": {
          ...
          "duration": "Weeks 1-4",
          "supplements": [],
          "dietary": ["Eliminate processed foods"],
          "lifestyle": ["Prioritize sleep"],
      ...
      ARRAY['Monitor for any adverse reactions'],
      '[
        {
          "name": "Energy levels",
      ...
      'Sample comprehensive analysis for testing purposes'
    );
  END IF;
END $$; 