      ...
      <Card className="bg-gray-800 border-gray-700">
        <CardContent className="p-6">
          <div className="flex items-center justify-center">
            ...
            <span className="ml-3 text-gray-300">Loading supplements...</span>
          </div>
        </CardContent>
      </Card>
    );
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-300">Total Supplements</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-300">Phase 1</div>
            </div>
            <div className="text-center">
        ...
        <CardContent>
          {supplements.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-300">No supplements found</p>
                    ...
                    <div className="mt-4 space-y-3 border-t border-gray-600 pt-3">
                      ...
                      {(supplement.interactions ||
                        ...
                        <div className="bg-yellow-900/30 border border-yellow-700/50 p-3 rounded-lg">
                          <h4 className="font-medium text-yellow-300 mb-2 flex items-center gap-1">
