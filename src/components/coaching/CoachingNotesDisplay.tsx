...
export function CoachingNotesDisplay({ clientId, clientName }: CoachingNotesDisplayProps) {
  ...
  const generateNotesContent = () => {
    ...
    const sections = [
      { title: 'Key Health Priorities', items: coachingNotes.keyHealthPriorities },
      { title: 'Supplement Rationale', items: coachingNotes.supplementRationale },
      { title: 'Lifestyle Recommendations', items: coachingNotes.lifestyleRecommendations },
      { title: 'Follow-Up Monitoring', items: coachingNotes.followUpMonitoring },
      { title: 'Red Flags to Watch', items: coachingNotes.redFlagsToWatch },
      { title: 'Motivation Strategies', items: coachingNotes.motivationStrategies },
    ];
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4">
        {sections.map((section) => (
          <Card key={section.title} className={`border-2 ${section.color}`}>
