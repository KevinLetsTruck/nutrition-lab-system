    ...
    >
      ...
      {status?.connected ? (
        <div className="space-y-2">
          <p className="text-green-700">✅ Connected and operational</p>
          <p className="text-sm text-gray-600">Model: {status.model}</p>
          {status.testAnalysis && (
        ...
        <div className="space-y-3">
          <p className="text-yellow-700">⚠️ Not connected - API key required</p>
          ...
          <div className="mt-3 p-3 bg-white rounded border border-yellow-100">
            <p className="text-xs text-gray-600">
              Once configured, Claude will analyze lab reports, identify
              patterns, and generate personalized protocols for your truck
              driver clients.
            </p>
          </div>
        </div>
