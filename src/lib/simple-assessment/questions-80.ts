...
export const SIMPLE_QUESTIONS: Question[] = [
  ...
  // Placeholders for remaining categories (41-80)
  // These will be expanded in the next step

  // Immune (Questions 41-50) - Currently only 5, needs 5 more
  {
    id: 41,
    category: "immune",
  ...
  // Hormonal (Questions 51-60) - Currently only 5, needs 5 more
  {
    id: 51,
    category: "hormonal",
  ...
  // Detox (Questions 61-70) - Currently only 5, needs 5 more
  {
    id: 61,
    category: "detox",
  ...
  // Cardiovascular (Questions 71-80) - Currently only 5, needs 5 more
  {
    id: 71,
