import { AssessmentQuestion, FunctionalModule, QuestionType, QuestionCategory } from '../types';
...
export const screeningQuestions: AssessmentQuestion[] = [
  // Energy & Fatigue Questions
  {
    ...
    scoringWeight: 1.5,
    clinicalRelevance: ["mitochondrial_function", "adrenal_health", "thyroid_function"],
  ...
  // Seed Oil Screening Questions
  {
    ...
    scoringWeight: 1.8,
    clinicalRelevance: ["oxidative_stress", "inflammation", "mitochondrial_function"],
  ...
  
  {
    ...
    helpText: "Industrial seed oils can contribute to inflammation and oxidative stress"
  },
  ...
  // Hormonal Screening
  {
    ...
    scoringWeight: 1.3,
    clinicalRelevance: ["thyroid_function", "insulin_resistance", "cortisol_dysregulation"],
  ...
  
  {
    ...
    scoringWeight: 2.0,
    clinicalRelevance: ["cell_membrane_integrity", "hormone_production", "vitamin_absorption"]
  },
  ...
  
  {
    ...
    options: [
      ...
      { value: "dont_know", label: "I don't know which oils to avoid", score: 7 }
    ],
    scoringWeight: 1.4,
