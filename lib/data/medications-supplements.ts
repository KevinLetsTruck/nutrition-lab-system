...
export const commonMedications = [
  ...
  // Sleep/Anxiety
  {
    name: "Trazodone",
    category: "Sleep",
    commonDosages: ["50mg", "100mg", "150mg"],
  },
  {
  ...
  },
  {
    name: "Prednisone",
    category: "Steroid",
    commonDosages: ["5mg", "10mg", "20mg", "50mg"],
  },
...
export const commonSupplements = [
  ...
  },
  {
    name: "Vitamin C",
    category: "Vitamin",
    commonDosages: ["500mg", "1000mg", "2000mg"],
  },
  {
    name: "Vitamin B12",
    category: "Vitamin",
    commonDosages: ["500mcg", "1000mcg", "5000mcg"],
  },
  {
    name: "B-Complex",
    category: "Vitamin",
  ...
  },
  {
    name: "Vitamin E",
    category: "Vitamin",
    commonDosages: ["200 IU", "400 IU", "800 IU"],
  },
  {
    name: "Vitamin K2",
    category: "Vitamin",
    commonDosages: ["45mcg", "90mcg", "120mcg"],
  },
  ...
  },
  {
    name: "Zinc",
    category: "Mineral",
    commonDosages: ["15mg", "25mg", "30mg", "50mg"],
  },
  {
    name: "Iron",
    category: "Mineral",
    commonDosages: ["18mg", "27mg", "65mg"],
  },
  {
    name: "Calcium",
    category: "Mineral",
  ...
  // Omega Fatty Acids
  {
    name: "Fish Oil",
    category: "Omega-3",
    commonDosages: ["1000mg", "2000mg", "3000mg"],
  },
  {
    name: "Omega-3",
    category: "Omega-3",
    commonDosages: ["500mg EPA/DHA", "1000mg EPA/DHA"],
  },
  {
    name: "Krill Oil",
    category: "Omega-3",
  ...
  // Probiotics & Digestive
  {
    name: "Probiotic",
    category: "Digestive",
    commonDosages: ["10 billion CFU", "25 billion CFU", "50 billion CFU"],
  },
  {
    name: "Digestive Enzymes",
    category: "Digestive",
    commonDosages: ["1 capsule", "2 capsules with meals"],
  },
  {
    name: "Betaine HCl",
    category: "Digestive",
    commonDosages: ["350mg", "650mg"],
  },
  {
    name: "L-Glutamine",
    category: "Digestive/Amino Acid",
  ...
  },
  {
    name: "Ashwagandha",
    category: "Adaptogen",
    commonDosages: ["300mg", "600mg", "1000mg"],
  },
  {
    name: "Rhodiola",
    category: "Adaptogen",
  ...
  // Amino Acids & Proteins
  {
    ...
    category: "Protein",
    commonDosages: ["10g", "20g"],
  },
  {
    name: "Whey Protein",
    category: "Protein",
    commonDosages: ["20g", "25g", "30g"],
  },
  {
    name: "L-Theanine",
    category: "Amino Acid",
  ...
  },
  {
    ...
    category: "Antioxidant",
    commonDosages: ["250mg EGCG", "500mg EGCG"],
  },
];
...
export function searchSupplements(query: string): typeof commonSupplements {
  const lowercaseQuery = query.toLowerCase();
  return commonSupplements.filter(
    (supp) =>
