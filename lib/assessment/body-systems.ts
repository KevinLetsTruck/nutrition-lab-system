...
export const bodySystemInfo = {
  [BodySystems.NEUROLOGICAL]: {
    ...
    targetQuestions: 20,
    keySymptoms: ["headaches", "brain fog", "memory", "mood", "sleep", "stress"]
  },
  [BodySystems.DIGESTIVE]: {
    name: "Digestive System", 
    description: "Stomach, intestines, and digestive function",
    targetQuestions: 20,
    keySymptoms: ["bloating", "gas", "bowel movements", "stomach pain", "food sensitivities"]
  },
  [BodySystems.CARDIOVASCULAR]: {
    name: "Cardiovascular System",
    description: "Heart, blood vessels, and circulation",
    targetQuestions: 15,
    keySymptoms: ["palpitations", "blood pressure", "chest pain", "circulation"]
  },
  [BodySystems.RESPIRATORY]: {
  ...
  [BodySystems.SPECIAL_TOPICS]: {
    ...
    targetQuestions: 20,
    keySymptoms: ["seed oils", "COVID-19", "vaccines", "driver health", "environmental"]
  }
};
