...
export const assessmentModules: AssessmentModule[] = [
  {
    ...
    description:
      "Initial comprehensive screening to identify primary areas of concern, including seed oil exposure assessment",
    questionCount: 75,
  ...
  },
  {
    ...
    description:
      "Comprehensive evaluation of digestive function, gut microbiome, and intestinal permeability",
    questionCount: 65,
  ...
  },
  {
    ...
    description:
      "Assessment of immune function, inflammatory status, and autoimmune risk factors",
    questionCount: 60,
  ...
  },
  {
    ...
    description:
      "Evaluation of cellular energy production, mitochondrial function, and metabolic efficiency",
    questionCount: 70,
  ...
  },
  {
    ...
    description:
      "Assessment of liver function, detox pathways, and toxic burden",
    questionCount: 55,
  ...
  },
  {
    ...
    description:
      "Evaluation of circulation, cardiovascular health, and lymphatic drainage",
    questionCount: 50,
  ...
  },
  {
    ...
    description:
      "Assessment of hormone levels, neurotransmitter balance, and nervous system function",
    questionCount: 75,
    activationThreshold: 15,
    questions: [],
    dependencies: [FunctionalModule.SCREENING],
  },
  {
    ...
    description:
      "Evaluation of structural alignment, joint health, and connective tissue integrity",
    questionCount: 45,
...
export const getNextModule = (
  currentModule: FunctionalModule,
  completedModules: Set<FunctionalModule>
...
export const moduleWeights: Record<FunctionalModule, number> = {
  [FunctionalModule.SCREENING]: 0.2,
  [FunctionalModule.ASSIMILATION]: 0.15,
  [FunctionalModule.DEFENSE_REPAIR]: 0.15,
  [FunctionalModule.ENERGY]: 0.15,
  [FunctionalModule.BIOTRANSFORMATION]: 0.1,
  [FunctionalModule.TRANSPORT]: 0.1,
  [FunctionalModule.COMMUNICATION]: 0.1,
